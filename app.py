...
if selected == "Home":
    ...
    with c3:
        st.image('https://media2.malaymail.com/uploads/articles/2020/2020-07/20200725_Singapore-HDB.jpg',use_container_width = True)
    with c4:
...
if selected == "About":
    ...
    st.markdown('''**Hello! I'm Nesal Prabhu M, a M.sc Mathematics graduate with a keen interest in data science and analytics.
                Currently on an exciting journey into the world of data science...**''')
    st.link_button('Linkedin','https://www.linkedin.com/in/nesalprabhu/') 
